...
if(isset($_POST['send'])){
    ...
    $select_contact = $conn->prepare("SELECT * FROM `contact_form` WHERE name = ? AND number = ?AND email = ? 
    AND courses = ? AND gender = ? ");
...
<body>
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Nam excepturi nobis cum error amet,</p>
                <a href="#contact" class="btn">contact us</a>
            </div>
        </div>
    </section>
        ...
        <div class="swiper course-slider">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide slide">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Voluptates beatae itaque tempora esse,</p>
                </div>

                <div class="swiper-slide slide">
                    <img src="images/course-2.svg" alt="">
                    <h3>digital marketiging</h3>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Voluptates beatae itaque tempora esse,</p>
                </div>
    ...
    <section class="reviews" id="reviews">
        ...
        <div class="swiper reviews-slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide slide">
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Voluptatum, excepturi.
                        Deleniti, repellat pariatur? Quidem ducimus quas consectetur delectus suscipit sint repudiandae
                        optio cum?
                        Totam ex eveniet beatae quisquam reiciendis.</p>
                    <div class="user">
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <form action="" method="post">
                ...
                <input type="number" required placeholder="Enter your valie number" max="999999999999" min="0"
                ...
                <select name="courses" class="box" required>
                    ...
                    <option value="digital marketiging">digital marketiging</option>
    ...
    <footer class="footer">
        <section>
            ...
            <div class="credit"> &copy; copyright @ 2022 by <span>miss. Amjaad Salawi</span> | all rights reserved!
            </div>
        </section>
    </footer>
    <!-- footer section ends -->
